...
public class CtrlParametros implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        try {
            ...
            String paraUnidad = vista.cmbUnidad.getItemAt(vista.cmbUnidad.getSelectedIndex());
    ...
    public void getUnidades(){
        List<UnidadParametros> unidadesList = new UnidadParametrosDAO().getAllUnidadParametroses();
        for (UnidadParametros unidadParamtem : unidadesList) {
            vista.cmbUnidad.addItem(unidadParamtem.getUn_descripcion());
        }
    }
    ...
    public void getJTable() {
        ...
        for (Parametros parametro : parametrosList) {
            model.addRow(new Object[]{parametro.getPara_id(), parametro.getPara_descripcion(), parametro.getPara_unidad(), parametro.getPara_estado(), parametro.getUsu_crea(), parametro.getFecha_crea(), parametro.getPara_fecha_anu(), parametro.getPara_formula(), parametro.getPara_referencia1(), parametro.getPara_referencia2()
            });
        }
    }
